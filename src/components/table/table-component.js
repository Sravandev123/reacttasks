...
function TableComponent(){
    ...
    return(
        <table>
            ...
            <td><img src="https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg" height={100} width={100}></img></td>
            </tr>
            ...
            <tr>
                ...
                <td>men's clothing</td>
                <td><img src="https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_.jpg" height={100} width={100}></img></td>

            </tr>

            <tr>
                <td>3</td>
                <td>Mens Cotton Jacke</td>
                <td>105.9</td>
                ...
                <td>men's clothing</td>
                <td><img src="https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_.jpg" height={100} width={100}></img></td>
            </tr>
            ...
            <tr>
                ...
                <td>men's clothing</td>
                <td><img src="https://fakestoreapi.com/img/71YXzeOuslL._AC_UY879_.jpg" height={100} width={100}></img></td>
            </tr>
        </table>
    )
}
